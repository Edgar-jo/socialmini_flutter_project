...
import 'package:prokit_socialmini/models/SVForumTopicModel.dart';
            ...
            children: [
              Stack(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset('images/socialmini/icons/ic_2User.png',
                          height: 16, width: 16, fit: BoxFit.cover),
                      8.width,
                      Text(tempList[index].name.validate(),
                          style: secondaryTextStyle(color: svGetBodyColor())),
                      20.width,
                      Image.asset('images/socialmini/icons/ic_Folder.png',
                          height: 16, width: 16, fit: BoxFit.cover),
                      8.width,
