...
import 'package:prokit_socialmini/models/SVPostModel.dart';
import 'package:prokit_socialmini/screens/home/screens/SVCommentScreen.dart';
                  ...
                  Row(
                    children: [
                      ...
                      Text(postList[index].name.validate(),
                          style: boldTextStyle()),
                      4.width,
                      Image.asset('images/socialmini/icons/ic_TickSquare.png',
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(
                        'images/socialmini/icons/ic_Chat.png',
                        height: 22,
                        width: 22,
                        fit: BoxFit.cover,
                      ...
                      IconButton(
                        icon: postList[index].like.validate()
                            ? Image.asset(
                                'images/socialmini/icons/ic_HeartFilled.png',
                                height: 20,
                                width: 22,
                                fit: BoxFit.fill)
                            : Image.asset(
                                'images/socialmini/icons/ic_Heart.png',
                                height: 22,
                                width: 22,
                                fit: BoxFit.cover,
                                color: context.iconColor,
                      ...
                      Image.asset(
                        'images/socialmini/icons/ic_Send.png',
                        height: 22,
                        width: 22,
                        fit: BoxFit.cover,
                        color: context.iconColor,
                      ...
                      children: [
                        Positioned(
                          child: Container(
                            ...
                            child: Image.asset(
                                    'images/socialmini/faces/face_1.png',
                                    height: 24,
                                    width: 24,
                                    fit: BoxFit.cover)
                        ...
                        Positioned(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                borderRadius: radius(100)),
                            child: Image.asset(
                                    'images/socialmini/faces/face_2.png',
                                    height: 24,
                                    width: 24,
                                    fit: BoxFit.cover)
                                .cornerRadiusWithClipRRect(100),
                        ...
                        Positioned(
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                borderRadius: radius(100)),
                            child: Image.asset(
                                    'images/socialmini/faces/face_3.png',
                                    height: 24,
                                    width: 24,
                                    fit: BoxFit.cover)
                                .cornerRadiusWithClipRRect(100),
